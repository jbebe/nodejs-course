...
const { DbLoadIndex, DbLoadTasks, DbLoadSubmissions } = require("../middlewares/database");
...
site.get('/task/:id', DbLoadTasks, DbLoadSubmissions, PartialRenderMenuMW, PartialRenderAdminMW, RenderSingleTaskMW);
